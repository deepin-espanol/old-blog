...
Tenemos un catálogo de <a href="{{ site.url }}{{ site.baseurl }}/guiapps/">muchas aplicaciones listas para usar</a>. En otro lado, seleccionamos <a href="{{ site.url }}{{ site.baseurl }}/destacado/">los pasos más importantes del manual</a> en una página especial (como correcciones críticas); y <a href="{{ site.url }}{{ site.baseurl }}/listados/">listados</a> con información que no tiene cabida en el manual, como comandos, fondos y microapps.

¿Piensas hacer una consulta o revisar el archivo? Te ofrecemos el <a href="{{ site.url }}{{ site.baseurl }}/search/">buscador</a> y la <a href="{{ site.url }}{{ site.baseurl }}/info/contacto/">página de contacto</a>. ¿Buscas descargar o actualizar Deepin? Recurre a un <a href="{{ site.url }}{{ site.baseurl }}/tips/mirror">espejo</a>. Otros detalles muy técnicos lo <a href="{{ site.url }}{{ site.baseurl }}/tips/mirror">encontraás en dicha categoría</a>.
