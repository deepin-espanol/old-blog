...
La terminal no te hace genial como [Jonny Lee Miller y Angelina Jolie en Hackers](https://en.wikipedia.org/wiki/Hackers_(film)). Si has usado "Símbolo de sistema" en Windows, tendrás que escribir `help` para conocer el listado de órdenes.
