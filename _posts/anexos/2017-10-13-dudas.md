...
Revisa la conexión a Internet. Si tienes un problema con el dispositivo Wifi revisa [Dudas sobre los controladores]({{ site.url }}{{ site.baseurl }}/anexos/dudas-drivers/).
