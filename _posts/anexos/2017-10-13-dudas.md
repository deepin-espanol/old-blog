...
### ¿Deepin usa un núcleo Linux?
Sí. Revisa el [código fuente]({{ site.url }}{{ site.baseurl }}/source) y las actividades que [puedes realizar]({{ site.url }}{{ site.baseurl }}/actividades/kernel/).

[Revisa la página para cambiar el núcleo de Linux]({{ site.url }}{{ site.baseurl }}/tips/kernel/).
<img class="t60" src="{{ site.urlimg }}header_homepage_13.jpg" alt="Paisaje">
