...
### Me fastidia que Deepin se comporte con cualquier comunidad tóxica por ser Linux

Quizás sea lo más complicado, [ya hubo casos en que los usuarios y los desarrolladores no estuvieron de acuerdo](https://victorhckinthefreeworld.com/2014/06/02/linux-apesta-y-los-linuxeros-tambien/). Pero tranquilo, estamos tratando de mejorar para que cualquier usuario(a) puede disfrutar, comentar y mantener al tanto con los <a href="{{ site.url }}{{ site.baseurl }}/novedades">avances</a>.
